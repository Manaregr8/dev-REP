                        ...
                        <li key={index} className="group relative">
                          {pathUrl !== "/" ? (
                            <Link
                              ...
                              scroll={false}
                              href={menuItem.path}
                              className={`ud-menu-scroll flex py-2 text-base text-dark group-hover:text-primary  dark:group-hover:text-primary lg:inline-flex lg:px-0 lg:py-6 ${pathUrl === menuItem?.path ? "text-primary dark:text-primary" : "dark:text-white"
                                }`}
                            >
                              {menuItem.title}
                            </Link>
                            ...
                            {menuItem?.submenu?.map((submenuItem: any, i) => (
                              <Link
                                ...
                                className={`block rounded px-2 py-[10px] text-sm ${pathUrl === submenuItem.path
                                  ? "text-primary"
                                  : "text-body-color hover:text-primary dark:text-dark-6 dark:hover:text-white"
                                  }`}
                              >
                                <span className="flex items-center gap-2 font-bold">
                                  ...
                                  />
                                  {submenuItem.title}
                                  <svg className={`dark:fill-white ml-auto`} xmlns="http://www.w3.org/2000/svg" width="24" height="24"><path d="M7 7h8.586L5.293 17.293l1.414 1.414L17 8.414V17h2V5H7v2z"/></svg>
                                </span>
                              </Link>
                            ))}
                          </div>
