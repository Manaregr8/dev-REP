    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
      <div className="relative w-full max-w-3xl rounded-lg bg-white shadow-lg">
        ...
        <div className="max-h-[80vh] overflow-y-auto p-8 pt-12">
          ...
          <p className="text-gray-700">Examples include:</p>
          <ul className="list-disc pl-5 text-gray-700">
            <li>Name</li>
            <li>Email address</li>
            <li>Phone number</li>
          ...
          <ul className="list-disc pl-5 text-gray-700">
            ...
            <li>
              Political opinions or affiliations (if directly relevant to
          ...
          <p className="text-gray-700">Your data helps us:</p>
          <ul className="list-disc pl-5 text-gray-700">
          ...
          <p className="text-gray-700">Cookies we use include:</p>
          <ul className="list-disc pl-5 text-gray-700">
            <li>
          ...
          <p className="text-gray-700">
            ...
            settings. Disabling certain cookies may affect the website's
            functionality.
          </p>
          ...
          <p className="text-gray-700">
            We respect your privacy and do not sell or rent your information.
            However, we may share data:
          </p>
          <h4 className="text-md mt-4 font-semibold text-gray-800">
          ...
          <p className="text-gray-700">
            ...
            may be transferred to the successor organization.
          </p>
          <h4 className="text-md mt-4 font-semibold text-gray-800">
            4. With Program Partners
          </h4>
          <p className="text-gray-700">
            Data may be shared with partners for the delivery of programs and
            services. Partner organizations are required to uphold our data
          ...
          <p className="text-gray-700">
            ...
            is 100% secure. We encourage users to exercise caution when sharing
            information online.
          </p>
          ...
          <p className="text-gray-700">To exercise these rights, contact us at privacy@devrhylme.org.
          </p>
          ...
          <p className="text-gray-700">
            ...
            you to review their policies before providing personal information.
          </p>
          ...
          <p className="text-gray-700">
            Devrhylme.org is not intended for children under 13. We do not
